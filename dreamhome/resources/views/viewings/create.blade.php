...
<main class="viewing-form-main">
    ...
    <section class="viewing-form-card cyan-glow">

        <div class="viewing-form-header">
            <div>
                <h1 class="viewing-form-title">Add Viewing</h1>
                <p class="viewing-form-subtitle">Create a new property viewing record</p>
            </div>
        </div>
        ...
        <form method="POST" action="{{ route('viewings.store') }}" class="viewing-form">
            @csrf
            ...
            <div class="viewing-form-actions">
                <button type="submit" class="viewing-submit-button">
                    Save Viewing
                </button>
