                ...
                document.addEventListener('DOMContentLoaded', function() {
                    ...
                    toggleButton.addEventListener('click', function() {
                        if (passwordInput.type === 'password') {
                            // Change input style to regular readable text
                            passwordInput.type = 'text';
                            
                            // When password is shown, show the Eye-Off icon (indicating next click hides it)
                            eyeIcon.style.display = 'block';
                            eyeOffIcon.style.display = 'none';
                        } else {
                            // Turn input back into secure hidden dots
                            passwordInput.type = 'password';
                            
                            // When password is hidden, show the regular open Eye icon
