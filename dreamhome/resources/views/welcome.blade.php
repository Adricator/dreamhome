...
<body class="antialiased bg-black overflow-hidden">
    ...
    <!-- Register Link -->
    <x-nav-link :href="route('register')" :active="request()->routeIs('register')" class="!text-white !font-bold !text-xs !uppercase hover:!text-gray-300 hover:!border-transparent transition duration-150 ease-in-out">
        {{ __('Register') }}
    </x-nav-link>
</div>
    </div>
